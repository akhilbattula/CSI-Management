...
$datarow = "";
        $query = "SELECT `cust_id`, `cust_first_name`,  `cust_address`, `cust_city`, `cust_state`, `cust_mobileno1`, `cust_aadhar`, `cust_purchasecount`,`cust_country`,`cust_postcode`,`cust_mobileno2`,`cust_last_name` FROM `customer` ORDER BY `cust_id` DESC";
        $result = mysqli_query($db, $query);
            ...
            if($count === 0){
                ...
                while($row2 = mysqli_fetch_array($result))
                {
                    ...
                    $datarow = $datarow."<tr><td><a style=\"text-decoration: underline;\" href=\"#\">$row2[0]</a></td><td>$cust_name</td><td>$address</td><td>$mobilenos</td><td>$row2[6]</td><td>$row2[7]</td><td><div class=\"dropdown\">
            <button class=\"btn btn-primary dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\">Action
            <span class=\"caret\"></span></button><ul class=\"dropdown-menu\"><li><a href=\"CustomerDetails.php?valueID=$row2[0]\">View</a></li><li><a href=\"EditCustomer.php?valueID=$row2[0]\">Edit</a></li>
              <li><a onClick=\"javascript: return confirm('Do you want to delete record?');\" href=\"../Delete.php?del_id=$row2[0]&del_type=customer\">Delete</a></li></ul></div></td></tr>";
        }
        }
                    ...
                    <div class="col-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Customers</h4>
                            </div>
                            <div class="card-body">
