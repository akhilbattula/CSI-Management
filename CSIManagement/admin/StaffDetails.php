...
$staff_id = $_GET['valueID'];

    $query_staff = "SELECT `staff_id`, `staff_first_name`, `staff_last_name`, `staff_gender`, `staff_dob`, `staff_address`, `staff_city`, `staff_state`, `staff_country`, `staff_postcode`, `staff_aadhar`, `staff_mobileno1`, `staff_mobileno2`, `staff_panno`, `staff_previous_employment`,`staff_designation`, `date_created`, `last_edited` FROM `staff` WHERE `staff_id`='$staff_id';";
...
<body class="fix-header fix-sidebar">
                ...
                <div class="col-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Staff Info</h4>
                            </div>
                            <div class="card-body">
                                <form class="form-horizontal" role="form">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="text-right col-md-3">Staff ID:</label>
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[0] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>    
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[1] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[2] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[3] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[4] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[10] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[13] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[5] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[6] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[7] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[9] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[8] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[11] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[12] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="text-right col-md-3">Designation:</label>
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[15] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="text-right col-md-3">Previous Employment:</label>
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[14] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555">  <?php echo $row_staff[16] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <p style="color: #555555"> <?php echo $row_staff[17] ?></p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <a href="EditStaff.php?valueID=<?php echo $row_staff[0] ?>"><button type="button" name="edit" id="edit" class="btn btn-info"><i class="fa fa-pencil"></i> Edit</button></a>
    ...
    <script>
        ...
        btn.addEventListener('click', function() {
            document.location.href = 'EditStaff.php?valueID=<?php echo $row_staff[0] ?>';
        });
    </script>
