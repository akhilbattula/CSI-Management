...
$error = "";
    $id = $_GET['id'];
    $query_shipment = "SELECT `shipment_id`, `dealer_name`, `no_of_products`, `total_price`, `gst_paid`, IFNULL(`comments`,'---'), `shipment_date`,`dealer_address` FROM `shipment` where shipment_id='$id';";
    ...
    $total_cost_paid = $row_shipment[3];
    $gst_paid = ($total_cost_paid/100)*$row_shipment[4];
...
<body class="fix-header fix-sidebar">
    ...
    <div id="main-wrapper">
                    ...
                    <div class="col-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Shipment Details</h4>
                            </div>
                            <div class="card-body">
            <table border="1" class="dummy">
        <tr>
            <td style="font-weight: bold ">
              Shipment Id:    
            </td>
            <td  colspan="5">
            <?php echo $row_shipment[0] ?>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
            <?php echo $row_shipment[1] ?>
            </td>
            <td>
            No. of Products:  
            </td>
            <td>
            <?php echo $count_of_products ?>
            </td>               
        </tr>
        <tr>
            <td>
        ...
        <tr>
            ...
            <td>
            <?php echo $total_cost_paid ?>
            </td>   
           <td>
            Shipment Date:  
            </td>
            <td>
            <?php echo $row_shipment[6] ?>
            </td>            
        </tr>
        <tr>
        <td>
        ...
        <td colspan="3">
        <?php if($row_shipment[5]===null || $row_shipment[5]==="")
            {
            echo "-";
            }else{
                echo $row_shipment[5];            
