...
if(!isset($_SESSION['login_user']))
{
    ...
    exit();
        ...
        $datarow = "";
        $query = "SELECT `staff_id`, `staff_first_name`,  `staff_address`, `staff_city`, `staff_state`, `staff_mobileno1`, `staff_aadhar`, `staff_gender`,`staff_country`,`staff_postcode`,`staff_mobileno2`,`staff_last_name`,`staff_designation` FROM `staff` ORDER BY `date_created` DESC";
        $result = mysqli_query($db, $query);
            ...
            if($count === 0){
                ...
                while($row2 = mysqli_fetch_array($result))
                {
                    ...
                    $datarow = $datarow."<tr><td><a style=\"text-decoration: underline;\" href=\"#\">$row2[0]</a></td><td>$staff_name</td><td>$row2[7]</td><td>$row2[12]</td><td>$address</td><td>$mobilenos</td><td>$row2[6]</td><td><div class=\"dropdown\">
            <button class=\"btn btn-primary dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\">Action
            <span class=\"caret\"></span></button><ul class=\"dropdown-menu\"><li><a href=\"StaffDetails.php?valueID=$row2[0]\">View</a></li><li><a href=\"EditStaff.php?valueID=$row2[0]\">Edit</a></li>
              <li><a onClick=\"javascript: return confirm('Do you want to delete record?');\" href=\"../Delete.php?del_id=$row2[0]&del_type=staff\">Delete</a></li></ul></div></td></tr>";
        }
        }
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">       
                                <div style="padding-top: 15px">
                                    <button type="button" style="float: right;width: 30%" name="add_customer" onclick="window.open('AddStaff.php','_self');" class="btn btn-success"><i class="fa fa-plus"></i> Add New Staff Member</button>
                            </div>
