...
$datarow = "";
$query = "SELECT `shipment_id`, `dealer_name`, `no_of_products`, `total_price`, `gst_paid`, IFNULL(`comments`,'---'), `shipment_date` FROM `shipment` order by `created_date` desc;";
$result = mysqli_query($db, $query);
    ...
    $count = mysqli_num_rows($result);
        ...
        while($row2 = mysqli_fetch_array($result))
        {
            ...
            $total_cost_paid = $row2[3];
            $gst_paid = ($total_cost_paid/100)*$row2[4];
            $amount_paid = $total_cost_paid - $gst_paid;
            $datarow = $datarow."<tr><td><a style=\"text-decoration: underline; color: blue;\" href=\"./ShipmentDetails.php?id=$row2[0]\">$row2[0]</a></td><td>$row2[1]</td><td>$count_of_products</td><td>$amount_paid</td><td>$gst_paid</td><td>$total_cost_paid</td><td>$row2[6]</td><td><div class=\"dropdown\"><button class=\"btn btn-primary dropdown-toggle\" type=\"button\" data-toggle=\"dropdown\">Action<span class=\"caret\"></span></button><ul class=\"dropdown-menu\"><li><a href=\"./ShipmentDetails.php?id=$row2[0]\">View</a></li><li><a href=\"./EditShipment.php?id=$row2[0]\">Edit</a></li><li><a onClick=\"javascript: return confirm('Do you want to delete record?');\" href=\"../Delete.php?del_id=$row2[0]&del_type=shipment\">Delete</a></li></ul></div></td></tr>";
                    ...
                    <div class="col-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">View Shipments</h4>
                            </div>
                            <div class="card-body">
