...
if(isset($_POST['add_product'])){
    ...
    $imei_count = mysqli_real_escape_string($db,$_POST['imei_nos']);
    $model_no = mysqli_real_escape_string($db,$_POST['model_no']);
   ...
   $sql_id = "select count(`prod_id`) from `product` where `prod_id` = '$prod_id'";
    ...
    $value = $row[0];
    if($row[0] === 1){
        $sql_add = "UPDATE `product` SET `no_in_stock`= `no_in_stock` + $quantity ,`last_edited`= '$date' WHERE `prod_id`='$prod_id';";
            if ($db->query($sql_add) === TRUE) {
                $sql_shipment_product = "INSERT INTO `shipment_products`(`prod_id`, `prod_category`, `prod_name`, `prod_price`, `gst_percentage`, `require_auth`, `imei_count`, `quantity`, `shipment_id`, `date_created`) VALUES ('$prod_id','$prod_category','$prod_name',$prod_price,$gst_percentage,'$require_auth',$imei_count,$quantity,'$from_shipment_id','$date')";
            ...
            $sql = "INSERT INTO `product`(`prod_id`, `prod_category`, `prod_name`, `prod_price`, `gst`, `require_auth`, `imei_nos`, `model_no`, `no_in_stock`, `from_shipment_id`, `date_created`) VALUES ('$prod_id','$prod_category','$prod_name',$prod_price,$gst_percentage,'$require_auth','$imei_count','$model_no',$no_in_stock,'$from_shipment_id','$date')";

            if ($db->query($sql) === TRUE) {
                                
                $sql_shipment_product = "INSERT INTO `product`(`prod_id`, `prod_category`, `prod_name`, `prod_price`, `gst`, `require_auth`, `imei_nos`, `model_no`, `no_in_stock`, `from_shipment_id`, `date_created`) VALUES ('$prod_id','$prod_category','$prod_name',$prod_price,$gst_percentage,'$require_auth','$imei_count','$model_no',$no_in_stock,'$from_shipment_id','$date')";
                            ...
                            <div class="card-body">
                                ...
                                <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>"  method="POST">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="ìmei_nos" class="form-control">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                    ...
                                    <div class="form-actions">
                                        <button type="submit" name="add_product" class="btn btn-success"> <i class="fa fa-check"></i> Save</button>
